...
class Optimizer:
    ...
    def run(self, imagePathOrDir,gender, sharedIdentity = False, checkpoint = None, doStep1 = True, doStep2 = True, doStep3 = True):
        '''
        ...
        print('2running optimization on: ', inputDir, " Gender:",gender)
        generateAvatar.start_generation(self.outputDir+"mesh0.obj",self.outputDir+"mesh0.fbx",self.outputDir,gender)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gender", required=False, default='m', help="gender of the avatar to be generated (m or f)")

...
def attach_face_to_body(body_file_path, face_file_path, bone_name, output_file_path):
    ...
    for obj in body_obj.children:
        if obj.name == 'Ch37_Body':
            body_mesh = obj
        elif obj.name == 'Ch37_Hair':
            hair_mesh = obj
        elif obj.name == 'Ch37_Pants':
            pants_mesh = obj
        elif obj.name == 'Ch37_Shirt':
            shirt_mesh = obj
    ...
    if body_obj and face_obj:
        ...
        if bone:
            ...
            face_obj.location = (0, -36.5, 10)  # Replace with desired translation distances
            face_obj.rotation_euler = (math.radians(173), math.radians(0), math.radians(0))  # Replace with desired rotation angles in radians
            face_obj.scale = (0.1, 0.1, 0.1)  # Replace with desired scale factors
            ...
            mat3.diffuse_color = (1.0, 0.7137, 0.7568, 1) 
...
bone_to_attach_To = 'mixamorig6:HeadTop_End'
